...
function Middleware(sharedRouter) {
   ...
   * List of all folders to be searched for controllers.
   * All `.js` files on the first hierarchy level will be parsed for valid operations
   *
   * @returns {function[]}
   */
  this.router = function(folders) {
    return router(folders);
  };
